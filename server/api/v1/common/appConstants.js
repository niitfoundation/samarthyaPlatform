...
const emailTemplate = {
    ...
    passwordReset: `<span style='font-size:14px;color:#92b9b9;padding-left:10%'>Hi,you can reset your password by clicking the below button.
    Don't share your password to anyone. Happy hiring..!</span><br><br>`,
    thankingRegistration: `<span style='font-size:14px;color:#92b9b9;padding-left:10%'>Thanks for signing up for Samarthya! 
